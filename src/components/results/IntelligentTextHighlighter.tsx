      ...
      {hoveredWord && (
        ...
        >
          ...
          <div className="text-sm">
            <div className="font-mono bg-gray-50 px-2 py-1 rounded mb-2">
              "{hoveredWord.word}"
            </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {hoveredWord.suggestions.slice(0, 3).map((suggestion, idx) => (
                    <button
                      key={idx}
                      className="block w-full text-left px-2 py-1 text-xs bg-blue-50 hover:bg-blue-100 rounded transition-colors"
            ...
            {suggestions
              ...
              .map((suggestion, idx) => (
                <div key={idx} className="mt-2 pt-2 border-t border-gray-200">
                  <div className="text-xs font-semibold text-gray-700">Context suggestion:</div>
                  <button
